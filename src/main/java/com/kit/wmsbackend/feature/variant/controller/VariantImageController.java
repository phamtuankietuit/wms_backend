package com.kit.wmsbackend.feature.variant.controller;
...
public class VariantImageController {
    ...
    public ResponseEntity<ApiResponse<List<MediaAssetResponse>>> list(@PathVariable UUID variantId) {
        return ResponseEntity.ok(ApiResponse.success(
                mediaAssetService.listImages(MediaOwnerType.VARIANT, variantId)
        ));
    }
    ...
    public ResponseEntity<ApiResponse<MediaAssetResponse>> setPrimary(
        ...
        return ResponseEntity.ok(ApiResponse.success(
                mediaAssetService.setPrimaryImage(MediaOwnerType.VARIANT, variantId, imageId)
        ));
    }
    ...
    public ResponseEntity<ApiResponse<Void>> delete(
        ...
        mediaAssetService.deleteImage(MediaOwnerType.VARIANT, variantId, imageId);
    ...
    public ResponseEntity<ApiResponse<Void>> bulkDelete(
            @PathVariable UUID variantId,
            @RequestBody @Valid MediaAssetBulkDeleteRequest request
    ) {
        mediaAssetService.bulkDeleteImages(MediaOwnerType.VARIANT, variantId, request.imageIds());
        return ResponseEntity.ok(ApiResponse.success(null));
    }
}

...
public class LessThanFilterStrategy<T> implements FilterStrategy<T> {
    ...
    public Predicate apply(Root<T> root, CriteriaBuilder cb, Path<?> path, Object value) {
        ...
        return cb.lessThan(resolvedPath.as(comparableValue.getClass()), (Comparable) comparableValue);
    }
}